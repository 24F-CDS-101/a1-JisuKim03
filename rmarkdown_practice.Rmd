...
The weekly interactive tutorials must be completed by the start of each week. The each weekly assignment will be due at the end of the week.

#  Course Goals
By the end of the course, students will be able to: 

- Use [GitHub](https://github.com/24F-CDS-101/a1-JisuKim03) for creating a reproducible research document.
    * My GitHub username is: _JisuKim03_
...
The second lind of output is printed out instead, but this means that the calculated value has been saved for future use.
